      ...
      <Box sx={{display: "flex", flexDirection: "column", justifyContent: "center", px: 20, py: 2 }} >
        ...
        <Box sx={{display: "flex", flexDirection: "column", justifyContent: "center", gap: 5}} >
          ...
          <Box>
            ...
            <Typography >本サービスは以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができます。</Typography>
            <ul >
              <li >
                <Typography >本規約の変更がユーザーの一般の利益に適合するとき。</Typography>
              </li>
              <li >
              <Typography >変更が合理的であるとき。</Typography>
              </li>
            </ul>
            <Typography >本サービスは、変更内容とその効力発生時期をユーザーに事前に通知します。</Typography>
          </Box>
          <Box>
